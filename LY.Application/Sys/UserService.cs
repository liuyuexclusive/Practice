...
namespace LY.Service.Sys
{
    public class UserService
    {
        ...
        private string GetJWTToken(Sys_User user)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(ConfigUtil.AppSettings["JWT:SecurityKey"]));
            ...
            var token = new JwtSecurityToken(
                audience: ConfigUtil.AppSettings["JWT:Audience"],
                issuer: ConfigUtil.AppSettings["JWT:Issuer"],
                claims: claims,
