...
namespace LY.Application.Sys
{
    public class WorkflowTypeService
    {
        ...
        //public IRepository<Sys_WorkflowTypeNode> WorkflowTypeNodeRepo { get; set; }
        //public IRepository<Sys_WorkflowTypeNodeAuditor> WorkflowTypeNodeAuditorRepo { get; set; }
