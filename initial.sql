...
DROP TABLE IF EXISTS sys_workflow_type;
CREATE TABLE sys_workflow_type (
  ...
  updatedOn TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY UQ_sys_workflow_type_name (NAME)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='工作流类型';

DROP TABLE IF EXISTS sys_workflow_type_node;
CREATE TABLE sys_workflow_type_node (
  id INT(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
DROP TABLE IF EXISTS sys_workflow_type_node_auditor;
CREATE TABLE sys_workflow_type_node_auditor (
  id INT(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
