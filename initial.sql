...
DROP TABLE IF EXISTS Sys_RoleEvent;
CREATE TABLE Sys_RoleEvent (
  ID INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  Type INT NOT NULL COMMENT '1.create,2.update,3.delete',
  AggregatedID INT(11) NOT NULL,
  Data json NULL COMMENT 'json数据',
  CreatedOn TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CreatedBy VARCHAR(255) NULL,
  Series BIGINT NOT NULL DEFAULT 0
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='角色事件表';
...
DROP TABLE IF EXISTS Sys_WorkflowTypeNode;
CREATE TABLE Sys_WorkflowTypeNode (
  ID INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
DROP TABLE IF EXISTS Sys_WorkflowTypeNodeAuditor;
CREATE TABLE Sys_WorkflowTypeNodeAuditor (
  ID INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
